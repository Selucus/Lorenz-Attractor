...
let a = 0.2, b = 0.2, c = 5.7; // Parameters
...
gui.add(params, 'a', 0, 2).step(0.01).onChange(function(value) {
    a = value;
});
gui.add(params, 'b', 0, 10).step(0.1).onChange(function(value) {
    b = value;
});
gui.add(params, 'c', 0, 10).onChange(function(value) {
    c = value;
});
...
gui.add(params, 'zoom', 1, 200).step(1).onChange(function(value) {
    zoom = value;
});
...
function updateRossler(dt, steps) {
