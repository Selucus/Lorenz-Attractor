...
let a = 0.95, b = 0.7, c = 0.6, d = 3.5, e = 0.25, f = 0.1; // Parameters
...
gui.add(params, 'a', 0, 5).step(0.01).onChange(function(value) {
    a = value;
});
gui.add(params, 'b', 0, 5).step(0.01).onChange(function(value) {
    b = value;
});
gui.add(params, 'c', 0, 5).step(0.01).onChange(function(value) {
    c = value;
});
gui.add(params, 'd', 0, 5).step(0.01).onChange(function(value) {
    d = value;
});
gui.add(params, 'e', 0, 5).step(0.01).onChange(function(value) {
    e = value;
});
gui.add(params, 'f', 0, 5).step(0.01).onChange(function(value) {
    f = value;
});
...
gui.add(params, 'zoom', 100, 600).step(1).onChange(function(value) {
    zoom = value;
});
...
function updateAizawa(dt, steps) {
